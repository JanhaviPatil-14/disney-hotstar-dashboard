...
* Majority content rated **TV-PG / TV-14**
* Indicates focus on **family + young adult audiences**
...
| Area             | Applied Skills                            |
| ---------------- | ----------------------------------------- |
| Data Handling    | Data Cleaning, Formatting, Validation     |
| Data Modeling    | Relationships, DAX Measures               |
| Visual Analytics | Dynamic filters, Interactive storytelling |
| Tools            | **Microsoft Power BI**                    |

This project showcases **business analytics mindset**, not just visualization skills.
...
📦 disney-hotstar-dashboard/
 ┣ 📊 Disney_Hotstar_Dashboard.pbix   → Main Dashboard
 ┣ 🖼 disney-hotstar-dashboard.png    → Preview Image
 ┣ 📄 disney_plus_titles.csv          → Source Dataset
